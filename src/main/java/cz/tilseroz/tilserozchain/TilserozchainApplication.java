package cz.tilseroz.tilserozchain;

import cz.tilseroz.tilserozchain.domain.Block;
import cz.tilseroz.tilserozchain.domain.Transaction;
...
public class TilserozchainApplication {
...
//        SpringApplication.run(TilserozchainApplication.class, args);
